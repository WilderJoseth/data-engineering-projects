...
The historical reporting flow loads trusted historical reporting data from `Sales_Analytics` into the target reporting platform.
...
| Prepare for reporting cutover | Ensure Warehouse Gold contains the required historical baseline before reporting ownership is transferred |
