...
CREATE TABLE [prod].[AddressType] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_AddressType_created_by] DEFAULT (USER_NAME()),
...
CREATE TABLE [prod].[ProductCategory] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_ProductCategory_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[ShipMethod] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_ShipMethod_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[CountryRegion] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_CountryRegion_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[SalesTerritory] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_SalesTerritory_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[StateProvince] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_StateProvince_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[SpecialOffer] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_SpecialOffer_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[Currency] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_Currency_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[CurrencyRate] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_CurrencyRate_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[CreditCard] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_CreditCard_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[Address] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_Address_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[Product] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_Product_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[SalesPerson] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_SalesPerson_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[Customer] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_Customer_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[SalesOrderHeader] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_SalesOrderHeader_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
...
CREATE TABLE [prod].[SalesOrderDetail] (
    ...
    [created_by] NVARCHAR(128) NOT NULL CONSTRAINT [df_prod_SalesOrderDetail_created_by] DEFAULT (USER_NAME()),
    [updated_at] DATETIME2(7) NULL,
    [updated_by] NVARCHAR(128) NULL,
    [created_execution_step_id] BIGINT NULL,
    [last_updated_execution_step_id] BIGINT NULL,
