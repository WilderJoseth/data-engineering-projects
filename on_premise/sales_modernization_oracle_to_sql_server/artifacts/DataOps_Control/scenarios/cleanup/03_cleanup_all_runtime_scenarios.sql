/*============================================================================
  ...
  Scope: Sales_Operational_Migration and Sales_Analytics_Migration scenarios

  Purpose:
  - Removes runtime and observability rows generated for process ids 21 and 28.
  - Keeps project metadata, process metadata, and monitoring metric metadata.

  Warning:
  - This deletes all execution evidence for project process ids 21 and 28.
============================================================================*/
...
AND es.[project_process_id] IN (21, 28);
