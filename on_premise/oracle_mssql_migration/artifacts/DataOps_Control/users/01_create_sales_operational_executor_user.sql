...
/*==============================================================
    ...
    Test login:
    - login_sales_operational_executor
...
IF NOT EXISTS (
    ...
    WHERE [name] = 'login_sales_operational_executor'
)
BEGIN
    CREATE LOGIN [login_sales_operational_executor]
...
/*==============================================================
    ...
    Test database user:
    - user_sales_operational_executor
==============================================================*/
...
IF NOT EXISTS (
    ...
    WHERE [name] = 'user_sales_operational_executor'
)
BEGIN
    CREATE USER [user_sales_operational_executor]
    FOR LOGIN [login_sales_operational_executor];
END;
GO
...
IF NOT EXISTS (
    ...
    AND m.[name] = 'user_sales_operational_executor'
)
BEGIN
    ALTER ROLE [DataOps_Project_Executor]
    ADD MEMBER [user_sales_operational_executor];
END;
GO
