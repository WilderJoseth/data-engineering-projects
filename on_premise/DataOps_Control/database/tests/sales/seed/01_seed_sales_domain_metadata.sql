...
VALUES
    ...
    (2102, 21, 2, 'Get initial reconciliation results', 'TABLE_VALUED_FUNCTION', 2, 'control', 'ufn_get_SalesOrderHeader_reconciliation_results', '{1}, {2}', 1),
    (2103, 21, 3, 'Validate work data', 'STORED_PROCEDURE', 2, 'work', 'usp_validate_SalesOrderHeader', '{1}', 1),
    (2104, 21, 4, 'Load final table', 'STORED_PROCEDURE', 2, 'prod', 'usp_load_SalesOrderHeader', '{1}', 1),
    (2105, 21, 5, 'Get final reconciliation results', 'TABLE_VALUED_FUNCTION', 2, 'control', 'ufn_get_SalesOrderHeader_reconciliation_results', '{1}, {2}', 1),
    (2106, 21, 6, 'Get load status code', 'SCALAR_FUNCTION', 2, 'control', 'ufn_get_SalesOrderHeader_load_status_code', '{1}', 1),
    (2107, 21, 7, 'End execution step', 'STORED_PROCEDURE', 4, 'runtime', 'usp_end_execution_step', '{1}, {2}', 1),
    (2108, 21, 8, 'Cleanup staging and work tables', 'STORED_PROCEDURE', 2, 'control', 'usp_cleanup_SalesOrderHeader', NULL, 1),
...
/*============================================================================
  ...
  Purpose:
  - Defines process-level monitoring expectations for executable load processes.
  - These rows configure expected ranges for runtime and observability metrics.
  - Actual measurements are stored later in observability.monitoring_results.

  Notes:
  - Monitoring metric codes are seeded in 01_seed_reference_data.sql.
  - id is omitted because metadata.project_process_monitoring_metrics uses IDENTITY.
  - ROW_COUNT is intentionally not assigned as a generic threshold here because
    row-count ranges are usually process/table/batch specific.
============================================================================*/
...
VALUES
    (10, 1, 0, 300, NULL, NULL, 'WARNING', 1),
    (10, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (10, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (10, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (11, 1, 0, 300, NULL, NULL, 'WARNING', 1),
    (11, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (11, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (11, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (12, 1, 0, 300, NULL, NULL, 'WARNING', 1),
    (12, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (12, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (12, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (13, 1, 0, 300, NULL, NULL, 'WARNING', 1),
    (13, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (13, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (13, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (14, 1, 0, 600, NULL, NULL, 'WARNING', 1),
    (14, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (14, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (14, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (15, 1, 0, 300, NULL, NULL, 'WARNING', 1),
    (15, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (15, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (15, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (16, 1, 0, 600, NULL, NULL, 'WARNING', 1),
    (16, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (16, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (16, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (17, 1, 0, 900, NULL, NULL, 'WARNING', 1),
    (17, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (17, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (17, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (18, 1, 0, 900, NULL, NULL, 'WARNING', 1),
    (18, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (18, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (18, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (19, 1, 0, 600, NULL, NULL, 'WARNING', 1),
    (19, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (19, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (19, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (20, 1, 0, 1200, NULL, NULL, 'WARNING', 1),
    (20, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (20, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (20, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (21, 1, 0, 3600, NULL, NULL, 'WARNING', 1),
    (21, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (21, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (21, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (22, 1, 0, 1200, NULL, NULL, 'WARNING', 1),
    (22, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (22, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (22, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (23, 1, 0, 600, NULL, NULL, 'WARNING', 1),
    (23, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (23, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (23, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (24, 1, 0, 600, NULL, NULL, 'WARNING', 1),
    (24, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (24, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (24, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (25, 1, 0, 900, NULL, NULL, 'WARNING', 1),
    (25, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (25, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (25, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (26, 1, 0, 600, NULL, NULL, 'WARNING', 1),
    (26, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (26, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (26, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (27, 1, 0, 900, NULL, NULL, 'WARNING', 1),
    (27, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (27, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (27, 4, 0, 0, NULL, NULL, 'ERROR', 1),
    (28, 1, 0, 3600, NULL, NULL, 'WARNING', 1),
    (28, 2, 0, 0, NULL, NULL, 'WARNING', 1),
    (28, 3, 0, 0, NULL, NULL, 'ERROR', 1),
    (28, 4, 0, 0, NULL, NULL, 'ERROR', 1);
GO

/*============================================================================
  12. Project Run Notifications

  Purpose:
  - Defines fixed run-level notification configuration for root migration
    processes.
  - Notifications are sent by the orchestration layer when an execution run is
    finalized with SUCCESS, FAILED, or OBSERVED.
  - DataOps_Control stores the configuration only; it does not send emails or
    Teams messages directly.
============================================================================*/

INSERT INTO [metadata].[project_notifications]
(
    [id],
    [project_id],
    [project_process_id],
...
(
    ...
    1,
    1,
    'Sales Operational Migration run notification',
    'Sends a summary when Sales_Operational_Migration finishes with SUCCESS, FAILED, or OBSERVED.',
    'EMAIL',
    N'Sales_Operational_Migration - Execution Summary',
    N'data-engineering-support@company.com;sales-migration-team@company.com',
    N'project-owner@company.com',
    NULL,
    1
),
(
    ...
    1,
    2,
    'Sales Analytics Migration run notification',
    'Sends a summary when Sales_Analytics_Migration finishes with SUCCESS, FAILED, or OBSERVED.',
    'EMAIL',
    N'Sales_Analytics_Migration - Execution Summary',
    N'data-engineering-support@company.com;sales-migration-team@company.com',
    N'project-owner@company.com',
    NULL,
    1
