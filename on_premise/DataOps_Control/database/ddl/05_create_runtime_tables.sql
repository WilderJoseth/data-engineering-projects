...
CREATE TABLE [runtime].[execution_runs] (
    ...
    CONSTRAINT [df_runtime_execution_runs_start_run_date] DEFAULT SYSUTCDATETIME(),
    CONSTRAINT [df_runtime_execution_runs_created_by] DEFAULT USER_NAME(),
...
CREATE TABLE [runtime].[execution_steps] (
    ...
    CONSTRAINT [df_runtime_execution_steps_start_step_date] DEFAULT SYSUTCDATETIME(),
    CONSTRAINT [df_runtime_execution_steps_created_by] DEFAULT USER_NAME(),
