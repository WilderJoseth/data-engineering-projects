/*============================================================================
  ...
  Scope: Sales_Operational_Migration / Sales Load scenarios

  Purpose:
  - Removes runtime and observability rows generated for process id 21.
  - Keeps project metadata, process metadata, and monitoring metric metadata.

  Warning:
  - This deletes all execution evidence for project process id 21.
============================================================================*/
